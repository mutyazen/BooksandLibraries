        ...
        <div class="col-md-12">
            <div class="row">
				<div class="col-md-12">
					<div class="row">
						<div class="col-md-12">
							<h1 class="mt-0 strong">List Library</h1>
							<hr>
						...
						<table id="dt" class="table table-striped table-bordered" style="width:100%">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{$row->name}}</td>
									<td>
										<button class="btn btn-info btn-detail" data-id="{{$row->id}}" data-uri="/library/detail"><i class="fa fa-eye"></i></button>
										<button class="btn btn-warning btn-edit" data-id="{{$row->id}}" data-uri="/library/detail"><i class="fa fa-pencil"></i></button>
										<button class="btn btn-danger btn-delete" data-id="{{$row->id}}" data-title="{{$row->name}}" data-uri="/library/delete"><i class="fa fa-trash"></i></button>
									</td>
								</tr>
								@endforeach
							</tbody>
...
<div class="modal fade" id="default-modal" role="dialog"><div class="modal-dialog"><div class="modal-content">
	<div class="modal-header">
		<h4 class="modal-title">Library - <span id="modal-type">New Entry</span></h4>
	...
	<div class="modal-body">
		<div class="col-md-12">
			<div class="row clearfix">
				<div class="col-md-12">
					<form method="POST" action="{{ route('library-save') }}" id="default-form">
						@csrf
						<div class="form-group">
							<label>Library Name</label>
							<input type="text" class="form-control" name="library_name" id="library-name">
						</div>
				</div>
			</div>
		</div>
